...
const WhatsAppControl = () => {
  ...
  const handleStartGroupIdRetrieval = async () => {
    ...
    try {
      const response = await startWhatsAppGroupIdRetrieval();
  ...
  const handleStopGroupIdRetrieval = async () => {
    ...
    try {
      const response = await stopWhatsAppGroupIdRetrieval();
  ...
  const handleForceReconnect = async () => {
    ...
    try {
      const response = await forceWhatsAppReconnect();
  ...
  const handleSendTestMessage = async (e) => {
    ...
    try {
      const response = await sendWhatsAppTestMessage(groupId);
