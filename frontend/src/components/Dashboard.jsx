  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        // Fetch clients
        try {
          const clientsData = await api.clients.getAll(token);
        ...
        try {
          const pendingDocuments = await api.documents.getPending(token);
        ...
        try {
          const reminderSettings = await api.settings.getReminders(token);
